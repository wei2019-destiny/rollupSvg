 ...
 * @LastEditTime: 2023-04-21 11:53:35
 * @FilePath: \svgdemo\src\parseString.js
 * @Description: 
 * 
 * Copyright (c) 2023 by bigemap/${git_name_email}, All Rights Reserved. 
 */
import headerHandler from './handlers/header.js'
import tablesHandler from './handlers/tables.js'
import blocksHandler from './handlers/blocks.js'
import entitiesHandler from './handlers/entities.js'
import objectsHandler from './handlers/objects.js'
